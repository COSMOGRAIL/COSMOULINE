...
def findcosmics(image, psfstars, sigclip, sigfrac, objlim):
	...
	for i in range(len(psfstars)):
		...
		# Creating the object :
		c = cosmics.cosmicsimage(a, pssl=pssl, gain=gain, readnoise=readnoise, sigclip=sigclip, sigfrac=sigfrac,
								 objlim=objlim, satlevel=satlevel,
								 verbose=False)  # I put a correct satlevel instead of -1, to treat VLT images.
