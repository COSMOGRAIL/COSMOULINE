...
import numpy as np
from src.lib.Candidate import Candidate
import sys
...
def get_stars(data, params, imgw=None, show=True):
...
#        numdisplay.readcursor()
        ...
        stars = get_stars(data, NOBJ, SKY_BACKGROUND[0], SIGMA_SKY[0], IMG_GAIN, VAL_BND, True, None, USE_MOMENTS)[0]#@UndefinedVariable
