...
if len(sys.argv) == 2:
    ...
    from config import decskiplist, decdir, deckeyfilenum, deckey, \
                       deckeypsfused, deckeynormused
...
print(f"You want to deconvolve the object '{decobjname}' with the PSFs from :")
...
for particularpsfname in decpsfnames:
    ...
    particulartreatedimages = [image[0] for image in particulartreatedimages] 
