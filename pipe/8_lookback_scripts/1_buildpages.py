...
for j, image in enumerate(images):
	...
	width = 256
	height = 256
	pngimages = ["psfstars.png", "psfresi.png", "psfback.png", "s.png"]
	npngimages = len(pngimages)
...
#	preparing the bla bla to write into the html page	
	...
	description.append("")
	description.append("Medcoeff : %5.2f (span : %5.2f), Renormalization coeff : %5.2f" % (image["medcoeff"], image["spancoeff"], image[deckeynormused]))
	description.append("")
	...
	description.append("Sky sigma [ADU] : %5.1f" % image["stddev"])
