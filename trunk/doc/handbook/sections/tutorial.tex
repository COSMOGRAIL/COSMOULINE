...
\tbrem{convert to electrons : makes the first hard copy of the images, but does not change the gain and saturlevel in the database. so to get the saturlevel to apply to your images, do gain * saturlevel yourself !}
