...
def deconv(data, params, savedir='results/'):
    ...
    sigmas = [data['objssig'][i][0].astype('float64') for i in xrange(nimg)]
...
#    r = fn.LG_filter(sshape, gres, c1, c2)
    ...
    dec = DecSrc(objs, sigmas, psfs, r, conv, img_shifts, _lambda, 
                 gres, nb_src, srcini, box_size, src_range, force_ini,
                 bkg_ini, bkg_ratio)
