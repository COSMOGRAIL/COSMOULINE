#
#	A scatter plot encoding the airmass as colours
...
for item in toplot:
	...
	groupedcatter = asarray(values(groupedimages, 'preredfloat2')['mean'])
	...
	plt.scatter(groupedmhjds, groupedmags, s=12, c=groupedcatter, vmin=0.8,vmax=15.0, edgecolors='none')
...
cbar.set_label('RMS of time-distance to flats [days]') 
