...
ptsrc = readmancatasstars(os.path.join(configdir, selectiondeckey + "_ptsrc.cat"))
...
specialcolumns = [{"name": "flux_" + src.name, "data":[image['out_' + selectiondeckey + '_'+ src.name +'_flux'] for image in images]} for src in ptsrc]
